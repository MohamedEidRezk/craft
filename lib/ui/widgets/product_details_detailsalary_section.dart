    ...
    return                         Row(
      ...
      children: [
        Column(crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(text1,
              style: TextStyle(fontWeight: FontWeight.w600 , fontSize: 18 , color: Color(0xff101623)),
            ),
            SizedBox(height: 1,),
            Text(text2,
              style: TextStyle(fontWeight: FontWeight.w600 , fontSize: 18 , color: Color(0xff101623)),
            ...
            SizedBox(height: 5,),
            Text(weightDetail,
              style: TextStyle(fontWeight: FontWeight.w500 , fontSize: 14 , color: Color(0xffA1A8B0)),
            ),
        ...
        Align(
          ...
          child: Column(
            ...
            children: [Text(salaryBefore,
              ...
              Text(salaryAfter,
                style: TextStyle(fontWeight: FontWeight.w600 , fontSize: 16 , color: Color(0xff7FB04F)),
              ),
            ],
          ),
        ),
